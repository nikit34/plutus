    ...
    >
      ...
      {!collapsed && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="mx-4 mt-5 p-3 rounded-xl bg-gold-dim border border-gold/10"
        >
          <div className="text-[11px] uppercase tracking-widest text-gold/70 mb-1">Заработок</div>
            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-xl bg-gold-dim border border-gold/10"
      ...
      {!collapsed && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="mx-3 mb-3 p-3 rounded-xl bg-bg-elevated border border-border"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-text-tertiary">{creator.plan} план</div>
            </div>
          </div>
        </motion.div>
      )}
